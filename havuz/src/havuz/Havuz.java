...
public class Havuz {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Musluk sayısını giriniz:");
    int n = myObj.nextInt()+1;
    int kapasite[]=new int[20];
    int musluk1[]=new int[50];
    int musluk2[]=new int[50];
    int kenarSayisi=0;
    do{
        Scanner myObj2 = new Scanner(System.in);
        System.out.println("Kenar bağlantı bilgisini ve kapasitesini giriniz:");
        musluk1[kenarSayisi] = myObj2.nextInt();
        musluk2[kenarSayisi] = myObj2.nextInt();
        kapasite[kenarSayisi] = myObj2.nextInt();
        kenarSayisi++;
    }while(musluk1[kenarSayisi]!=0 || musluk2[kenarSayisi]!=0 || kapasite[kenarSayisi-1]!=0 );
    Scanner myObj2 = new Scanner(System.in);
    System.out.println("Başlangıç ve bitiş musluklarının indeksini giriniz:");
    int bas = myObj2.nextInt();
    int son = myObj2.nextInt();

    NetworkFlowSolverBase solver = new FordFulkersonDfsSolver(n, bas, son);
    
    for(int i=0;i<kenarSayisi-1;i++){
        solver.addEdge(musluk1[i], musluk2[i], kapasite[i]);
    }
    ...
    for (List<Edge> edges : resultGraph) 
        for (Edge e : edges) 
            System.out.println(e.toString(bas, son));
  }
}
